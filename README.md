...
```bash
curl -fsSL https://raw.githubusercontent.com/hotbrainco/copilot-bootstrap/v0.1.15/copilot-bootstrap.sh -o copilot-bootstrap.sh
...
# or pin a version
BOOTSTRAP_TAG=v0.1.15 bash bootstrap/scripts/update.sh
```
